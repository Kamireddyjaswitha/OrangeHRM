...
@Test
public void jobcategoryCheckbox() {
	try {
		...
		job.click();
		WebElement jobcategory = driver.findElement(By.linkText("Job Categories"));
		jobcategory.click();
		WebElement checkbox = driver.findElement(By.xpath("//*[@id=\"app\"]/div[1]/div[2]/div[2]/div/div/div[3]/div/div[2]/div[3]/div/div[1]/div/div/label/span/i"));
		checkbox.click();
		Thread.sleep(5000);
		driver.close();
	}catch(Exception e) {
